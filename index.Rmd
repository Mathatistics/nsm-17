...
<center><a href = "simrel-flowchart/index.html" class = "fragment">Extensive Flowchart</a></center>
...
## Simulation Design {data-background=#f2f2f2 .header-slide}
...
## A Systematic Comparison {data-background=#f2f2f2 .header-slide}
<div class="fragment">
...
## A Systematic Comparison {data-background=#f2f2f2 .header-slide data-transition="none"}
...
<div id = "right">
- OLS prediction is very poor in noisy data with many predictor variables
- Position of relvant component and the decaying factor of eigenvalue had less impact on prediction in all the models
</div>
</div>
...
## { data-background-image='images/simulatr-screenshot.png' data-background-color=#f2f2f2 .header-slide}
