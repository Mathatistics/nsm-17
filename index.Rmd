...
<div class="flex-content flex-container">
<div class="flex-content fragment" data-fragment-index="1">
- Get parameter setting from users
- Create Covariance matrix
</div>
<div class="flex-content fragment" data-fragment-index="2">
- Create Rotation Matrix
- Rotate the sampled Latent variables
</div>
</div>
</div>
...
- Educational use
- Student can learn how a method such as variable selection removes irrelevant variables
